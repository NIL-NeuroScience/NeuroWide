function [parcellation] = ApplyParcellation(data_warped,AllenAtlas,AllenOutline,regions_table,hemi,tolerance,make_plot)
...
%         disp(strcat(['extracting ts for left',' ',label]))
        ...
        ts = NeuroWide.allenAtlas.ExtractTimeseries(data_warped,overlap);
        allTS(:,r) = ts;
