function [] = Do_Registration(dat,brain_mask)
...
New_Registration = 1; % Turns to 0 when user is satisfied with registration
    ...
    InitialTform = NeuroWide.allenAtlas.InitialRegistration(moving,fixed,N_points,rotate_first,'nonreflectivesimilarity',threshold);
...
%     moving = moving.*brain_mask;
    ...
    app = NeuroWide.allenAtlas.InteractiveImageRegistration(moving,fixed,regions_table,AllenOutline,InitialTform,threshold);
