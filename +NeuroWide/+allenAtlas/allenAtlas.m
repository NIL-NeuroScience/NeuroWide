function [parcellation] = allenAtlas(img, brain_mask, isLeft)
%%
...
NeuroWide.allenAtlas.Do_Registration(tmpIn,brain_mask);

tmpIn = double(tmpIn).*brain_mask;
% tmpIn = uint16(tmpIn);

parc = NeuroWide.allenAtlas.Finish_Registration(tmpIn,evalin('base','FinalTform'),Tolerance,isLeft);
