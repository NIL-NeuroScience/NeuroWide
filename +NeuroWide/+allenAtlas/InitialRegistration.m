function [initial_tform] = InitialRegistration(moving,allen,Ncp,rotate,transform_type,threshold)
...
[movingPoints,~] = NeuroWide.allenAtlas.create_landmarks(moving_t,allen,Ncp,rotate,threshold);
