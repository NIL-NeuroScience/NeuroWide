function [rawImageChannels,metadata] = andorDATImporter(folderIn, settings)
...
% 
% AndorDATImporter imports time series data from Andor Solis software
% into MATLAB.
% 
% AndorDATImporter() will process data in current directory using
% standard settings and shows a montage of the DF/F and DR/R time series.
% AndorDATImporter(folderIn) will process data within folderIn using standard settings.
% AndorDATImporter(folderIn,settings) will process data within folderIn using user-defined settings.
% 
